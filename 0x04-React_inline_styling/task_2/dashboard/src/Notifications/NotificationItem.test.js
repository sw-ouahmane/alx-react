...
describe("Notification item rendering tests", () => {
    ...
    it('renders correct output for type and value props', () => {
        ...
        expect(wrapper.html()).toEqual('<li data-notification-type="default" class="defaultNotification_33nt1u">test</li>');
    });
    ...
    it('renders correct output for html props', () => {
        ...
        expect(wrapper.html()).toEqual('<li data-notification-type="urgent" class="urgentNotification_jh3f1s"><u>test</u></li>');
    });
